...
def main():
    ...
    links_df = pd.read_csv(path + r'\data\raw\first_league\01_players_links_{date}.csv'.format(date=var.time_stamp),
                           delimiter=',')
    ...
    for link in link_list:
        ...
        # player status
        player_status = site.find('div', class_='col-md-8')
        player_status = player_status.find('div', class_='mb-3')
        ...
        data_tuples = list(zip(col_id, col_name, col_position, col_value, col_club, col_club_abr, col_club_prev,
                               ...
                               col_penalty_given, col_penalty_lost, col_penalty_defend, col_yellow,
                               col_red, col_points))
        ...
        player_stats = pd.DataFrame(data_tuples, columns=["id", "name", "position", "value", "club", "club_abr",
                                                          ...
                                                          "penalty_defended", "yellow_card", "red_card", "points"])
