...
def main():
    ...
    for link in link_list:
        ...
        player_club_abr = ""
        player_position = site.find('h4').text
        ...
        data_tuples = list(zip(col_id, col_name, col_position, col_value, col_club, col_club_abr, col_club_prev,
                               ...
                               col_penalty_won, col_penalty_given, col_penalty_lost, col_penalty_defend, col_yellow,
                               col_red, col_points))
        ...
        player_stats = pd.DataFrame(data_tuples, columns=["id", "name", "position", "value", "club", "club_abr",
                                                          ...
                                                          "penalty_lost", "penalty_defended", "yellow_card",
                                                          "red_card", "points"])
