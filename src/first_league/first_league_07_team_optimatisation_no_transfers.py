...
def main():
    ...
    players_stats = pd.read_csv(project_dir + r'\data\interim\first_league\08_players_updated_values_25FEB21.csv', delimiter=',')
...
def select_team(expected_scores, prices, positions, clubs, total_budget=28, sub_factor=0.2):
