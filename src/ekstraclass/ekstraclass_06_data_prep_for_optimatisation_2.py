...
def main():
    ...
    players_stats = pd.read_csv(project_dir + r'\data\raw\Players_stats_hist_12DEC20.csv', delimiter=',')
    ...
    # saving dataframe
    players_stats_sum.to_csv(project_dir + r'\data\interim\Players_sum_stats_hist_{date}.csv'.format(date=time_stamp),
